                ...
                if st.session_state.selected_site is not None:
                    ...
                    with tab2:
                        ...
                        try:
                            ...
                            popular_pages = df_aggregated_popular_page[(df_aggregated_popular_page['Average CTR'] > formatted_ctr_m) & (df_aggregated_popular_page['Clicks'] > average_clic_df_popular))]
