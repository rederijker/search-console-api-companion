                ...
                with st.container():
                    ...
                    with col2:                                       
                        ...
                        if check_box_row == 'Yes':
                            row_limit = st.number_input('Row limit', min_value=1, max_value=100, value=100)
                        else:
                    ...
                    with st.spinner("Downloading data..."):
                        ...
                        while True:                     
                            ...
                            if row_limit is not None:
                                request_body["rowLimit"] = min(row_limit, 100)  # Imposta il limite massimo a 25.000
                            else:
                                request_body["rowLimit"] = 100  # Imposta un limite predefinito a 25.000
                            ...
                            if len(response_data.get('rows', [])) < 100 and (row_limit is None or start_row + len(response_data.get('rows', [])) >= row_limit):
